...
class FormatVisitor : public LuaBaseVisitor {
   public:
    FormatVisitor(const vector<Token*>& tokens, const Config& config)
        : tokens_(tokens), config_(config) {}
    ...
    antlrcpp::Any visitFunctioncall(
        LuaParser::FunctioncallContext* context) override;
    ...
    antlrcpp::Any visitRepeatStat(
        LuaParser::RepeatStatContext* context) override;
    ...
    antlrcpp::Any visitLocalFuncStat(
        LuaParser::LocalFuncStatContext* context) override;
    antlrcpp::Any visitLocalVarDecl(
        LuaParser::LocalVarDeclContext* context) override;
    ...
    antlrcpp::Any visitAttnamelist(
        LuaParser::AttnamelistContext* context) override;
    ...
    antlrcpp::Any visitNameAndArgs(
        LuaParser::NameAndArgsContext* context) override;
    antlrcpp::Any visitArgs(LuaParser::ArgsContext* context) override;

    antlrcpp::Any visitFunctiondef(
        LuaParser::FunctiondefContext* context) override;
    ...
    antlrcpp::Any visitTableconstructor(
        LuaParser::TableconstructorContext* context) override;
   ...
   private:
    ...
    bool needKeepBlockOneLine(tree::ParseTree* previousNode,
                              LuaParser::BlockContext* ctx,
                              BlockType blockType);
    bool isBlockEmpty(LuaParser::BlockContext* ctx);
    void visitBlockAndComment(tree::ParseTree* previousNode,
                              LuaParser::BlockContext* ctx,
                              BlockType blockType);
