...
// TEST_CONFIG_ERROR_FILE(PROJECT_PATH + "/tests/.data/Config/column_limit.config");
// TEST_CONFIG_ERROR_FILE(PROJECT_PATH + "/tests/.data/Config/column_table_limit.config");

// TEST_ZERO_CONFIG_ERROR_FILE(PROJECT_PATH + "/tests/.data/Config/indent_width.config");

TEST_CONFIG_NO_ERROR_FILE(PROJECT_PATH + "/tests/.data/Config/spaces_before_call.config");
TEST_CONFIG_NO_ERROR_FILE(PROJECT_PATH + "/tests/.data/Config/no_error_quote.config");
TEST_CONFIG_NO_ERROR_FILE(PROJECT_PATH + "/tests/.data/Config/no_error_tab.config");

TEST_CONFIG_QUOTE_CONFLICT_ERROR_FILE(PROJECT_PATH + "/tests/.data/Config/single_to_double.config");

TEST_CONFIG_TAB_CONFLICT_ERROR_FILE(PROJECT_PATH + "/tests/.data/Config/tab.config")
