add_repositories("antlr4 https://github.com/antlr/antlr4.git")
...
repo .. "antlr4/runtime/Cpp/runtime/src/**.cpp"
)
del_files("src/main.cpp")
add_includedirs("src/parser", repo .. "yaml/include",
    repo .. "antlr4/runtime/Cpp/runtime/src", 
    "src", repo .. "args", repo .. "catch/include"
    )